...
var gTests = [{host:"[::dafe:afcf:efbc:fdee:cdae:edaf:aaed]",
hostPort:"[::dafe:afcf:efbc:fdee:cdae:edaf:aaed]",
spec:"//[::dafe:afcf:efbc:fdee:cdae:edaf:aaed]",
prePath:"//[::dafe:afcf:efbc:fdee:cdae:edaf:aaed]"}
]
